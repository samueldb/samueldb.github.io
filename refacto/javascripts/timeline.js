...
//  version v0.2 by samuel db. original from here : http://bl.ocks.org/rengel-de/5603464
...
function timeline(domElement) {
    ...
    var timeline = {},   // The timeline
        ...
        bandGap = 5,    // Arbitray gap between to consecutive bands
    ...
    timeline.band = function (bandName, sizeFactor) {
        ...
        band.trackHeight = Math.min((band.h - band.trackOffset) / data.nTracks, 150);
        //band.itemHeight = band.trackHeight * 0.9,
        band.itemHeight = band.trackHeight * 1.5,         // hauteur du rectangle
        band.parts = [],
    ...
    timeline.labels = function (bandName) {
        ...
        var bandLabels = chart.append("g")
            ...
            .attr("transform", "translate(0," + (band.y + band.h + 2) +  ")")
